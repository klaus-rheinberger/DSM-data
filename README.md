...
For the PV data a simple one day-ahead prediction is computed as a weighted sum: $p=0.75$ is the weight of the values of the prediction day, and $(1 - p)$ is the weight of the values of the day before. (Only the first day of the time series is handled differently, see the code.)
If required, this method can be applied by users to the RG and HH time series.

The problem of predicting EV data is not handled by this repository.
